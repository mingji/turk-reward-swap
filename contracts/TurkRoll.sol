...
// TurkRoll helps your migrate your existing Uniswap LP tokens to TurkSwap LP ones
contract TurkRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'TurkSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'TurkRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'TurkRoll: INSUFFICIENT_B_AMOUNT');
    }
